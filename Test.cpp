...
TEST_CASE("AscendingIterator")
{
    ...
    SUBCASE("Iterators are pointing at different containers")
    {
        MagicalContainer container6;
        container6.addElement(2);
        container6.addElement(4);
        container6.addElement(1);
        container6.addElement(8);
        MagicalContainer::AscendingIterator it6(container6);

        MagicalContainer container7;
        container7.addElement(4);
        container7.addElement(5);
        container7.addElement(6);
        container7.addElement(3);
        MagicalContainer::AscendingIterator it7(container7);

        CHECK_THROWS_AS(it6 = it7, std::runtime_error);
    }
}
...
TEST_CASE("SideCrossIterator")
{
    ...
    SUBCASE("Try to increment beyond the end")
    {
        MagicalContainer container4;
        container4.addElement(1);
        container4.addElement(3);
    ...
    {
        MagicalContainer container5;
        container5.addElement(2);
        container5.addElement(4);
        container5.addElement(1);
        container5.addElement(8);
        MagicalContainer::SideCrossIterator it5(container5);

        MagicalContainer container6;
        container6.addElement(4);
        container6.addElement(5);
        container6.addElement(6);
        container6.addElement(3);
        MagicalContainer::SideCrossIterator it6(container6);

        CHECK_THROWS_AS(it5 = it6, std::runtime_error);
    }
}
...
TEST_CASE("PrimeIterator")
{
    ...
    SUBCASE("ContainerWithoutPrimes")
    {
        ...
        MagicalContainer::PrimeIterator primeIter(container3);
    ...
    SUBCASE("After increments comparing two iterators")
    {
        MagicalContainer container5;
        container5.addElement(1);
        container5.addElement(3);
        ...
        MagicalContainer::PrimeIterator it1(container5);
        MagicalContainer::PrimeIterator it2(container5);
    ...
    SUBCASE("Try to increment beyond the end")
    {
        ...
        MagicalContainer::PrimeIterator primeIter(container6);
    ...
    {
        MagicalContainer container7;
        container7.addElement(2);
        container7.addElement(4);
        container7.addElement(8);
        MagicalContainer::SideCrossIterator it7(container7);

        MagicalContainer container8;
        container8.addElement(4);
        container8.addElement(5);
        container8.addElement(3);
        MagicalContainer::SideCrossIterator it8(container8);

        CHECK_THROWS_AS(it7 = it8, std::runtime_error);
    }
}
